...
<meta name="csrf-token" content="{{ csrf_token() }}" />
  ...
  <title>Pristine @yield('title')</title>
    ...
    <nav class="main-header navbar navbar-expand navbar-dark" style="background: #16a49a;">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="{{ route('cmsFormRegister') }}" class="nav-link">Form Register</a>
      </ul>
...
<footer class="main-footer">
  <strong>Copyright &copy; {{ date('Y') }} <a href="" style="color: #302149;">Pristine.8.6+ 2023</a></strong>
</footer>
</div>
<!-- ./wrapper -->
