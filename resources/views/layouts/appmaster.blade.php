...
<head>
  ...
  <title>SORAK SORAI @yield('title')</title>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center" style="background: white;">
      <img src="{{ asset('images/vici/vici.png') }}" alt="AdminLTELogo" height="60" width="250">
    </div>
...
<footer class="main-footer">
  <strong>Copyright &copy; {{ date('Y') }} <a href="" style="color: black;">VICI</a></strong>
</footer>
</div>
<!-- ./wrapper -->
