...
<div class="content-wrapper" style="background: white;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{$studios[0]->nama_studio}}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active">{{$studios[0]->nama_studio}}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{url('/CMS/event/update/' . $studios[0]->id_studio)}}" method="POST">
                        @csrf
                        @method("PUT")
                        <div class="form-group mb-3">
                            ...
                            <select name="cabangs_id" class="form-control @error('cabangs_id') is-invalid @enderror">
                                <option value="{{$studios[0]->cabangs_id}}">{{$studios[0]->cabang->nama_kota}}</option>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" value="{{$studios[0]->nama_studio}}" name="nama_studio" class="form-control @error('nama_studio') is-invalid @enderror">
                            @error('nama_studio')
                                <span class="invalid-feedback">
                                    {{$message}}
                                </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="tgl" value="{{$studios[0]->tgl}}" class="form-control @error('tgl') is-invalid @enderror">
                            @error('tgl')
                                <span class="invalid-feedback">
                                    {{$message}}
                                </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="time" name="jam_mulai" value="{{$studios[0]->jam_mulai}}" class="form-control @error('jam_mulai') is-invalid @enderror">
                            @error('jam_mulai')
                                <span class="invalid-feedback">
                                    {{$message}}
                                </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="time" name="jam_selesai" value="{{$studios[0]->jam_selesai}}" class="form-control @error('jam_selesai') is-invalid @enderror">
                            @error('jam_selesai')
                                <span class="invalid-feedback">
                                    {{$message}}
                                </span>
                        ...
                        <div class="btn-send">
                            <button type="submit" class="btn btn-warning" style="float: right">Update Event</button>
                        </div>
                    </form>
                </div>
            </div>
